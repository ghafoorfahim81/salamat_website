...
@section('content')
    <div id="app" v-cloak>
        <!-- Breadcrumb -->
        <d-header :title="'Create Document'" :show-icon="true" :url="`{{ route("roles.index") }}`"></d-header>
        <div class="w-full bg-white rounded-lg shadow mt-1 dark:bg-gray-800">
            <div class="mt-2">
                <form class="p-4 needs-validation" action="{{route('role.update',$role->id)}}"
                    ...
                    <div class="fc9-form row">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6 p-2">
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role name</label>
                                <input type="text" id="first_name" value="{{$role->name}}"  name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Role name" required>

                            </div>
                            <div class="relative z-0 w-full mb-6 group">

                                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                <textarea id="message"  name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write something about this role...">{{$role->description}}</textarea>
                    ...
                    <div class="text-right py-2">
                        ...
                        hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800
                         ...
                         text-sm px-5 py-2.5 text-center mr-2 mb-2" @click="handleSubmit($event)">Save Role</button>
